...
<div id="home" class="tab-content">
    ...
    <!-- HERO SECTION -->
    <section class="relative overflow-hidden bg-white rounded-[2rem] shadow-soft border border-slate-100">
        <div class="absolute inset-0 bg-gradient-to-br from-brand-50 via-white to-emerald-50"></div>
        <div class="relative grid lg:grid-cols-2 gap-10 items-center px-8 md:px-14 py-14 md:py-20">
            
            <div>
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-50 border border-brand-100 text-brand-700 text-xs font-bold uppercase tracking-widest mb-6">
                    <span class="w-2 h-2 rounded-full bg-brand-500 animate-pulse"></span>
                    Program Perlindungan Sosial Banyumas
                </div>

                <h1 class="font-heading text-4xl md:text-6xl font-extrabold text-slate-900 leading-tight tracking-tight">
                    Satu ASN,<br>
                ...
                <p class="mt-6 text-slate-500 text-lg leading-relaxed max-w-xl">
                    Program Salin Aslimas (Sadewo Lintarti ASN Peduli Pekerja Banyumas) merupakan wujud nyata kepedulian Aparatur Sipil Negara (ASN) Kabupaten Banyumas dalam memberikan perlindungan sosial ketenagakerjaan bagi pekerja rentan di lingkungan sekitar..
                </p>

                <div class="mt-8 flex flex-wrap gap-4">
                    <button onclick="showTab('form')" class="bg-slate-900 text-white px-8 py-4 rounded-xl font-semibold hover:bg-slate-800 transition shadow-lg">
                        Ajukan Sekarang
                    </button>

                    <button onclick="showTab('check')" class="border border-slate-200 px-8 py-4 rounded-xl font-semibold text-slate-700 hover:bg-slate-50 transition">
                        Cek Kepesertaan
                    </button>
                </div>

                <div class="grid grid-cols-3 gap-4 mt-10">
                    <div class="bg-white border border-slate-100 rounded-2xl p-4 shadow-card">
                        <p class="text-3xl font-bold text-brand-600">100%</p>
                        <p class="text-xs text-slate-500 mt-1">Komitmen Sosial</p>
                    </div>
                    <div class="bg-white border border-slate-100 rounded-2xl p-4 shadow-card">
                        <p class="text-3xl font-bold text-brand-600">27+</p>
                        <p class="text-xs text-slate-500 mt-1">OPD Terlibat</p>
                    </div>
                    <div class="bg-white border border-slate-100 rounded-2xl p-4 shadow-card">
                        <p class="text-3xl font-bold text-brand-600">∞</p>
                        <p class="text-xs text-slate-500 mt-1">Manfaat Jangka Panjang</p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative">
                ...
                <img src="<?php echo $def_foto_bupati; ?>" class="relative rounded-[2rem] shadow-soft w-full object-cover h-[620px] object-top">
            </div>
                    ...
                    <div>
                        ...
                        <div id="worker-container" class="space-y-6 pl-0 md:pl-14">
                            ...
                            <div class="bg-white border border-slate-200 p-6 rounded-2xl shadow-card relative group">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-2 text-sm">
                                    ...
                                    <div><label class="block text-xs font-semibold text-slate-500 mb-1">No HP Pekerja/Keluarga </label><input type="text" name="worker_hp[]" class="input-premium"></div>
                        ...
                        <div class="pl-0 md:pl-14 mt-6">
                            <button type="button" onclick="addWorker()" class="w-full py-4 bg-slate-50 border-2 border-dashed border-slate-200 text-slate-500 rounded-2xl font-semibold hover:bg-slate-100 hover:text-slate-700 hover:border-slate-300 transition flex items-center justify-center gap-2">
                                <i class="fas fa-plus"></i> Tambah Pekerja Rentan Lainnya
                            </button>
                        </div>
                    </div>
            ...
            <table class="w-full text-left border-collapse bg-white">
                <thead class="bg-slate-50 border-b border-slate-200">
                    <tr>
                        ...
                        <th class="py-4 px-6 text-center text-xs font-bold text-slate-500 uppercase tracking-wider">Total Usulan Pekerja</th>
                        <th class="py-4 px-6 text-center text-xs font-bold text-slate-500 uppercase tracking-wider">Pekerja Rentan Terlindungi</th>
                    </tr>
                </thead>
